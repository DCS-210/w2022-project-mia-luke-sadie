...
ggplot(nyc_squirrels, aes( x=behavior, y=primary_fur_color)) + 
...
```{r}
nyc_squirrels %>%
  mutate(hectare = str_sub(hectare_number, start = 1, end = 2)) %>%
  mutate(hectare = str_sub(hactare_letter, start = 3, end = 3)) %>%
```

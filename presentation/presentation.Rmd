...
```{r, echo=FALSE}
style_xaringan(
  title_slide_background_image = "img/bagel-squirrel-el479311939574.jpg"
)
```
...
# How is behavior shifted based on time of week?
...
- Conduct a revised NYC Squirrel census that is more encompassing of area (takes into account humans, other areas of New York, and other animals in the area)

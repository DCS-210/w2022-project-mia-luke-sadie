...
# An Introduction to our dataset: NYC_Squirrels 
...
- When compiling the total census population, they employed a divide and conquer method, dividing Central Park into 350 hectares. 
- Then, the volunteers spread out and counted and observed squirrels once in the morning and once at night.
- They then calculated the total number of squirrels by using a formula developed by Vagn Flyger, a squirrel biologist. 

---

# The Demographics of Squirrels in Central Park 
...
```{heat_map_squirrel_density, echo = FALSE, out.width = "60%", fig.align = "center", fig.cap = "Heat Map of Squirrel Density" ("https://69563a3b36fe4ac9a74bbf3e79b6bf01.app.rstudio.cloud/file_show?path=%2Fcloud%2Fproject%2Fpresentation%2Fheatmap3.gif")}
